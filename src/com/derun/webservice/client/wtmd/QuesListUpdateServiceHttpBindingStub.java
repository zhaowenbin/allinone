...
public class QuesListUpdateServiceHttpBindingStub extends org.apache.axis.client.Stub implements com.derun.webservice.client.wtmd.QuesListUpdateServicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.wtmd.derun.com", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://beans.derun.com", "QuesListUpdateReqInfo"), com.derun.webservice.client.wtmd.QuesListUpdateReqInfo.class, false, false);
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://beans.derun.com", "QuesListUpdateResInfo"));
        oper.setReturnClass(com.derun.webservice.client.wtmd.QuesListUpdateResInfo.class);
    ...
    public QuesListUpdateServiceHttpBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.derun.webservice.client.wtmd.QuesListDefTaxInfo[].class;
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.QuesListUpdateInfo[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.QuesListCarTaxInfo.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.QuesListUpdateReqInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.QuesListUpdateResInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service.wtmd.derun.com", ">anyType2anyType2anyTypeMapMap>entry");
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.AnyType2AnyType2AnyTypeMapMapEntry.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.AnyType2AnyTypeMapEntry.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.LoadQuesList.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.LoadQuesListResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service.wtmd.derun.com", "anyType2anyType2anyTypeMapMap");
            cachedSerQNames.add(qName);
            cls = com.derun.webservice.client.wtmd.AnyType2AnyType2AnyTypeMapMapEntry[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://service.wtmd.derun.com", ">anyType2anyType2anyTypeMapMap>entry");
    ...
    public com.derun.webservice.client.wtmd.QuesListUpdateResInfo loadQuesList(com.derun.webservice.client.wtmd.QuesListUpdateReqInfo in0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.derun.webservice.client.wtmd.QuesListUpdateResInfo) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.derun.webservice.client.wtmd.QuesListUpdateResInfo) org.apache.axis.utils.JavaUtils.convert(_resp, com.derun.webservice.client.wtmd.QuesListUpdateResInfo.class);
            }
        }
