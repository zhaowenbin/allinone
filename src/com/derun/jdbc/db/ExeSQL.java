...
import com.derun.util.DateUtil;
import com.derun.util.StrTool;
import com.derun.util.SysConst;
...
public class ExeSQL
{
	private static Logger log = Logger.getLogger(ExeSQL.class.getName());
